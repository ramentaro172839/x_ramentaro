...
TikTok成長リサーチ（アフィリエイト活用目的）用のナレッジ・スキル・プロンプト一式。
アフィリエイト導線は**DM誘導型**（動画→視聴者からDM→リンク返信）を前提とする。

- `knowledge/tiktok_growth_knowledge.md` — アルゴリズム・伸びるフォーマット・アフィリエイト市場動向・日本のステマ規制まとめ
